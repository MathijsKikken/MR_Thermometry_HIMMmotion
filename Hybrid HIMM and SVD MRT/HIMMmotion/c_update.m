function c = c_update(imgs,Z,A,c,tes,prc,mask)
%% MR thermometry of RF heating in the human brain at 7T using the HIMM MRT method with SVD-based motion correction
% c_update: function to find the coefficients on the background 
% polynomial/spherical harmonics fit to background phase
%
...
%   A:          polynomial/spherical harmonics basis functions
